	...
	<div class="row heading-bg">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h5 class="txt-dark"><? echo isset($s->ad_id) ? 'Update' : 'Add' ?> Advisor</h5>
		</div>
					<!-- Breadcrumb -->
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url() ?>admin/dashboard">Dashboard</a></li>
				<li><a href="<?php echo base_url() ?>admin/users/advisors">Advisors</a></li>
				<li class="active"><span><? echo isset($s->ad_id) ? 'Update' : 'Add' ?> Advisor </span></li>
			</ol>
		</div>
					<!-- /Breadcrumb -->
	</div>	
						...
						<div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
						        ...
						        <div class="container">
						         ...
						         <form method="post" action="<? echo base_url('admin/users/insert_advisor_Data') ?>" enctype="multipart/form-data">
								  <div class="form-content">
								   ...
								   <div id="error"></div>
									  ...
									  <div class="col-md-3">
										...
										<div class="form-group">
										  <input type="file" class="form-control" name="image" <? echo isset($s->ad_id) ? '' : 'required' ?>>
									  ...
									  <div class="col-md-12" style="padding-bottom: 20px">
									  	<input type="hidden" name="id" value="<? echo isset($s->ad_id) ? $s->ad_id : '' ?>">
