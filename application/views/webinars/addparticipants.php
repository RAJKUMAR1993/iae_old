				  ...
				  <div class="form-content card-view">
				   ...
				   <div id="error"></div>
					...
					<div class="row" align="center">	
						...
						<a href="<? echo base_url('webinar/joinevent/')?><?php echo $this->session->userdata("event_id") ?>" class="btn btn-primary" style="margin-top: 20px;"><i class="fa fa-chevron-left"></i> Back</a>	
					</div>	
					<div class="clearfix"></div>
				  </div>
