	...
	<link href='<? echo base_url() ?>assets/css/dragula.css' rel='stylesheet' type='text/css' />
	<link href='<? echo base_url() ?>assets/css/example.css' rel='stylesheet' type='text/css' />
...
<? $this->load->view( "admin/back_common/footer" ); ?>
	...
	<script src="<? echo base_url() ?>assets/js/dragula.js"></script>
	<script src="<? echo base_url() ?>assets/js/example.min.js"></script>
