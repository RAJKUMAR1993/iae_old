...
<?php 
	$pdata = $this->db->order_by("sort_order","asc")->get_where("tbl_testimonials")->result();
	foreach($pdata as $p){ ?>
		<div class="row">
			<div class="col-md-3 col-xs-12 hidden-xs" style="margin-bottom: 15px">
				<img src="<? echo base_url() ?><? echo ($p->photo != '') ? 'assets/testimonals/'.$p->photo : 'assets/images/default.png' ?>" class="img-responsive" alt="" width="100%">
