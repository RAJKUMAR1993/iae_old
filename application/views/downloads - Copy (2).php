      ...
      <div class="row" style="font-weight:bold;">
        <div class="col-md-12  black">
         <?php $system_ip = $this->input->ip_address(); $res = $this->db->get_where("tbl_users_download",array("ip"=>$system_ip))->row();   if($res->ip == $system_ip){ ?>
			...
			<a class="list-group-item list-group-item-action active">Download Presentations</a>
			<a href="<?php echo base_url(); ?>assets/NIRF/1-NIRF&AICTE-INITIATIVES-Prof-Poonia.pptx" class="list-group-item list-group-item-action">1. NIRF & AICTE INITIATIVES by Prof. MP Poonia </a>
			<a href="<?php echo base_url(); ?>assets/NIRF/2-Graduate-Outcomes-Prof-N-Siva-Prasad.pptx" class="list-group-item list-group-item-action">2. Graduate Outcomes by Prof.N. Siva Prasad</a>
			<a href="<?php echo base_url(); ?>assets/NIRF/3-Research-and-Teaching-Quality-Parameters-Pandhari-Pande.pptx" class="list-group-item list-group-item-action">3. Research and Teaching Quality Parameters by Pandhari Pande</a>
			<a href="<?php echo base_url(); ?>assets/NIRF/4-Quality-Out-come-based-education-and-Accreditation-Prof-SC-Sahasrabudhe-Presentation.pptx" class="list-group-item list-group-item-action">4. Quality Outcome based Education and Accreditation by Prof. SC Sahasrabudhe </a>
			<a href="<?php echo base_url(); ?>assets/NIRF/5-NBA-Anil-Kumar-Nasaa.pptx" class="list-group-item list-group-item-action">5. NBA by Anil Kumar Nasaa</a>
			<a href="<?php echo base_url(); ?>assets/NIRF/6-NIRF-Ranking-Dr-Meena-Chintamaneni.pptx" class="list-group-item list-group-item-action">6. NIRF Ranking by Dr. Meena Chintamaneni</a>
			...
			<a href="<?php echo base_url(); ?>assets/NIRF/9-Changing-Paradim-Dr-B-S-Madhukar.pptx" class="list-group-item list-group-item-action">9. Changing Paradim by Dr. B.S. Madhukar</a>
			<a href="<?php echo base_url(); ?>assets/NIRF/10-Perception-Aniruddha-S-Dasu.pptx" class="list-group-item list-group-item-action">10. Perception by Aniruddha S Dasu</a>
