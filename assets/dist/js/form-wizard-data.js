	...
	if($('#example-advanced-form').length >0){
		...
		form_2.steps({
			...
			if(currentIndex == 0){
				...
				var name = $("#exampleInputuname").val();
				var email = $("#exampleInputEmail").val();
				var mobile = $("#exampleInputMobile").val();
				var otp = $("#exampleInputOtp").val();
				
				if($("input[name='category']:checked").is(':checked')){
				...
				var url = $('#base').val()+'Students/insertStudent';
				$.ajax({
					
					type : "post",
					url : url,
					data : {category:category,name:name,email:email,mobile:mobile,otp:otp},
					dataType: "json",
