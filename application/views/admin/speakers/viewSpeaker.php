...
.select2-container--default .select2-selection--multiple .select2-selection__choice {
	...
	<div class="row heading-bg">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h5 class="txt-dark"><? echo isset($s->id) ? 'Update' : 'Add' ?> Speaker</h5>
		</div>
					<!-- Breadcrumb -->
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			<ol class="breadcrumb">
				...
				<li class="active"><span><? echo isset($s->id) ? 'Update' : 'Add' ?> Speaker </span></li>
			</ol>
		</div>
					<!-- /Breadcrumb -->
	</div>	
						...
						<div class="panel panel-default card-view">
							...
							<div class="panel-wrapper collapse in">
						        ...
						        <div class="container">
						         ...
						         <form method="post" action="<? echo base_url('admin/speakers/insertData') ?>" enctype="multipart/form-data">
								   ...
								   <div id="error"></div>
									  ...
									  <div class="col-md-3">
										...
										<div class="form-group">
										  <input type="text" class="form-control" placeholder="Name of the speaker" value="<? echo isset($s->sname) ? $s->sname : '' ?>" name="sname" required>
										</div>
									  </div>
									  ...
									  <div class="col-md-3">
									  	<label>Route</label>
										<div class="form-group">
									  	  <input type="text" class="form-control" placeholder="Route" value="<? echo isset($s->route) ? $s->route : '' ?>" name="route" required>	
										</div>
									  </div>		
									  ...
									  <!--<div class="col-md-3">
										...
										<div class="form-group">
										  <input type="text" class="form-control" placeholder="Enter Sorting Order" value="<? //echo isset($s->sorting_order) ? $s->sorting_order : '' ?>" name="sorting">
										</div>
									  </div>-->
									  <div class="col-md-7">
									  	<label>Event</label>
									  ...
									  <div class="col-md-12">
										...
										<div class="form-group">
										  <textarea rows="4" cols="50" class="form-control" id="desc" name="desc" placeholder="Description" autocomplete="off" required><? echo isset($s->description) ? $s->description : '' ?></textarea>
										</div>
									  </div>
