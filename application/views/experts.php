  ...
  <section class="white-background black" id="inpage">
	...
	<?php if($this->uri->segment(3) != ""){ ?>
		...
		<div align="center" style="margin-top: 15px">		  
     	   <a class="btn btn-info" style="text-align: center" href="<?php echo base_url(); ?>home/experts"> <i class="fa fa-chevron-left"></i> Back to Experts</a>
        </div><br>
	<?php }else{ ?>
		<?php foreach($pdata as $p){ ?>
		<a href="<?php echo base_url(); ?>home/experts_detail/<?php echo $p->ex_id; ?>">
		<div class="row">
			<div class="col-md-3 col-xs-12 hidden-xs" style="margin-bottom: 15px">
