	...
	<div class="row heading-bg">
		<div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
			<h5 class="txt-dark">List of Speakers</h5>
		</div>
					<!-- Breadcrumb -->
		<div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
			<ol class="breadcrumb">
				<li><a href="<?php echo base_url() ?>admin/dashboard">Dashboard</a></li>
				<li class="active"><span>Speakers List</span></li>
			</ol>
		</div>
					<!-- /Breadcrumb -->
	</div>	
							...
							<div class="panel-wrapper collapse in">
						     	...
						     	<div class="row">
									<div class="col-md-12" style="padding: 5px 0px 0px 20px">
										<a href="<? echo base_url('admin/speakers/speaker') ?>" class="btn btn-primary">Add</a>
									</div>
								</div>    
...
<!--												<th>Sorting Order</th>-->
											...
											?>
												...
												<tr>
													...
													<td>
														<a href="<? echo base_url("admin/speakers/speaker/").$row->id?>"><i class="fa fa-edit"></i></a>&nbsp;&nbsp;
														<a href="<? echo base_url("admin/speakers/delSpeaker/").$row->id?>" onclick="return confirm('Are you sure want to delete.')"><i class="fa fa-trash"></i></a>
													</td>
												</tr>
