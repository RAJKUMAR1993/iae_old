  ...
  <section id="gallery">
    <div class="gal-container center-block text-center">
	  ...
	  <div class="panel-body">
			...
			<? 
				$images = $this->db->where(array("route"=>$this->uri->segment(3),"deleted"=>0,"type"=>"image"))->get("tbl_gallery")->result();
		  	...
		  	?>
				...
				<div class="gallery-wrap">
					...
					<li class="item filter" data-src="<?php echo base_url().$img->images ?>">
								...
								<img class="img-responsive" style="width: 100%" src="<?php echo base_url().$img->images ?>"  alt="<? echo $img->description ?>" />
